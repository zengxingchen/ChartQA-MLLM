...
data = [
    {'Month': 'January', 'Urban Areas': '25%', 'Rural Areas': '30%', 'Suburban Areas': '45%'},
    {'Month': 'February', 'Urban Areas': '28%', 'Rural Areas': '35%', 'Suburban Areas': '37%'},
...
pivot_df.plot(kind='bar', stacked=True, color=colors, figsize=(12, 8), width=0.75)

plt.title('Monthly Distribution of Population by Area Type', pad=20)
