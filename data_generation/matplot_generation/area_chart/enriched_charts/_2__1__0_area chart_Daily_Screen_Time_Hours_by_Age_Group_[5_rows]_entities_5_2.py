...
plt.fill_between(df['Date'], df['Views'], color='#FFA07A', alpha=0.5)
plt.plot(df['Date'], df['Views'], color='#FF6347', alpha=0.8)

plt.title('Monthly Website Views Over Three Years', fontsize=16)
