...
# BASE_MODEL=${1:-"models/llava-v1.6-vicuna-13b"}
BASE_MODEL=${1:-"models/llava-v1.5-13b"}
CKPT=${2:-"llava-v1.5-13b-lora-ChartInstruct"}
mkdir -p ./playground/eval/chartqa/$CKPT

echo "Using checkpoint: $CKPT"
ROOT_MODEL_PATH="./checkpoints/$CKPT"
# ROOT_MODEL_PATH="./checkpoints-unfreezed/$CKPT"
