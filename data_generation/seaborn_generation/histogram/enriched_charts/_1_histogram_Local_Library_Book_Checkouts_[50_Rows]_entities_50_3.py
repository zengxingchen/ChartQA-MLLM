...
# Creating a histogram with the specified bin width and color.
sns.histplot(df['Age'], bins=20, color='#007acc', kde=False)

# Customizing plot labels and title.
plt.title('Age Distribution of a Fictional Population', fontsize=18)
