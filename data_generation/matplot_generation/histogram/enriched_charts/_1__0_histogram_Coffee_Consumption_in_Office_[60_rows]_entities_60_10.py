...
plt.hist(durations, bins=20, orientation='vertical', color='#ff5733', edgecolor='black', linewidth=1.2)
plt.title('Duration of Outdoor Activities (in minutes)', pad=20)
plt.xlabel('Duration (minutes)')
plt.ylabel('Frequency')
plt.xticks(range(0, max(durations) + 1, 50))
