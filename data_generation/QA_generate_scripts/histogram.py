...
if __name__ == "__main__":
    ...
    parser.add_argument('--chart_dir', type=str,
                        default=r'E:\VIS2024\chart-understanding\data_engine\bench_space_data\diverse_scripts\temp2\overall_dataset\histogram')
    parser.add_argument('--save_dir', type=str,
                        default=r'E:\VIS2024\chart-understanding\data_engine\bench_space_data\diverse_scripts\temp2\overall_dataset\histogram_QA')
