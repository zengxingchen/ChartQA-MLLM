...
sales = [150, 180, 220, 300, 350, 400, 380, 370, 360, 310, 260, 200]
...
plt.title('Monthly Sales Figures for ABC Company', fontsize=16)  # Change the headline and topic
...
plt.annotate('Peak Sales', xy=(months[highest_sales_idx], sales[highest_sales_idx]), 
             xytext=(months[highest_sales_idx], sales[highest_sales_idx]+30),
