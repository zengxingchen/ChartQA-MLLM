...
def generate_diversified_vega_lite_code(args):
    ...
    try:
        ...
        diversified_json_path = os.path.join(save_dir, f"_11_{filename}")
        ...
        csv_filename = f"_11_{os.path.splitext(filename)[0]}.csv"
...
def main(data_dir, save_dir, max_workers):
    ...
    file_paths = [os.path.join(data_dir, f) for f in os.listdir(data_dir) if f.endswith('.json')][100:300]
